...
export default function TestRecordList() {
    ...
    const [statusTab, setStatusTab] = useState<"success" | "giveup" | "fail">(
        "success",
    );
    ...
    const fetchHabits = useCallback(async () => {
        try {
            setIsLoading(true);
            let url = "/api/members/habits/success/";

            if (statusTab === "giveup") {
                url = "/api/members/habits/giveup/";
            } else if (statusTab === "fail") {
                url = "/api/members/habits/fail/";
            }
        ...
        <div className={styles.container}>
            ...
            {statusTab === "success" && filteredHabits.length > 0 && (
                <div className={styles.celebrate}>
                    ...
                    />
                    <p>
                        <strong>{filteredHabits.length}개의 습관</strong>을
                        만드셨군요!
                        <br />
                        잘하고 있어요 :)
                    </p>
